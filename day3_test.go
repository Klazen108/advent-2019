...
func TestDay3Example3(t *testing.T) {
	result := Challenge3_1("R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51\nU98,R91,D20,R16,D67,R40,U7,R15,U6,R7")
	if result != "135" {
		t.Errorf("Result was incorrect, got: %s, want: %s.", result, "135")
	}
}
